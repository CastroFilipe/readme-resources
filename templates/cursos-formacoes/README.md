### [Utilizar esse template na criação de repositórios de estudos como cursos e formações. O stastus, progresso, principais tecnologias e demais informações do curso devem ser atualizados de acordo.] 
